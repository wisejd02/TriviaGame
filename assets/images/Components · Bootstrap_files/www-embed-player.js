...
A(B,Error);B.prototype.name="CustomError";var Ca=Array.prototype.indexOf?function(a,b){return Array.prototype.indexOf.call(a,b,void 0)}:function(a,b){if(r(a))return r(b)&&1==b.length?a.indexOf(b,0):-1;
...
function sc(a,b){if(a.classList)var c=a.classList.contains(b);else c=rc(a),c=0<=Ca(c,b);return c}
...
K[1]);var Aa=!(K[3]>=z())&&0!=e;if(Z||g||Aa)g=z(),h=g+1E3*h,k=g+1E3*k,1E-5>Math.random()&&(g="https://pagead2.googlesyndication.com/pagead/gen_204?id=imerr&err="+e,p.google_image_requests||(p.google_image_requests=[]),Aa=p.document.createElement("img"),Aa.src=g,p.google_image_requests.push(Aa)),u[5]=e,u[1]=f,u[2]=h,u[3]=k,u[4]=m,u[6]=b,Id();if(Z||!M.ca()){e=M.ka();for(f=0;f<e.length;f++)M.ia(e[f]);e.length=0}}};
Kd(a)}
...
var rf=1;function sf(){if(!tf&&!uf||!window.JSON)return null;try{var a=tf.get("yt-player-two-stage-token")}catch(b){}if(!r(a))try{a=uf.get("yt-player-two-stage-token")}catch(b){}if(!r(a))return null;try{a=JSON.parse(a,void 0)}catch(b){}return a}
var uf,vf=new nd;uf=vf.isAvailable()?new jd(vf):null;var tf,wf=new od;tf=wf.isAvailable()?new jd(wf):null;function xf(){var a=P("ROOT_VE_TYPE",void 0);return a?new pf(void 0,a,void 0):null}
function yf(){var a=P("client-screen-nonce")||P("EVENT_ID");return a?a:null}
;function zf(a,b,c){Zb.set(""+a,b,c,"/","youtube.com",!1)}
;function Af(a){if(a){a=a.itct||a.ved;var b=v("yt.logging.screen.storeParentElement");a&&b&&b(new pf(a))}}
;function Bf(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=P("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=P("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=sd(J(window.location.href)[3]||null);f&&e.push(f);f=sd(J(d)[3]||null);if(0<=Ca(e,f)||!f&&0==d.lastIndexOf("/",0))if(S("autoescape_tempdata_url")&&(e=document.createElement("a"),Eb(e,d),d=e.href),d){f=J(d);d=f[5];e=f[6];f=f[7];var g="";d&&(g+=d);e&&(g+="?"+e);f&&(g+="#"+f);d=g;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e)){if(b.itct||b.ved)b.csn=b.csn||
yf();if(h){var h=parseInt(h,10);isFinite(h)&&0<h&&(d="ST-"+Ua(d).toString(36),e=b?ud(b):"",zf(d,e,h||5),Af(b))}else h="ST-"+Ua(d).toString(36),d=b?ud(b):"",zf(h,d,5),Af(b)}}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var u=void 0===u?window:u;c=u.location;a=vd(a,k)+m;a=a instanceof E?a:Ab(a);c.href=yb(a)}return!0}
;t("yt.abuse.botguardInitialized",v("yt.abuse.botguardInitialized")||se,void 0);t("yt.abuse.invokeBotguard",v("yt.abuse.invokeBotguard")||te,void 0);t("yt.abuse.dclkstatus.checkDclkStatus",v("yt.abuse.dclkstatus.checkDclkStatus")||bf,void 0);t("yt.player.exports.navigate",v("yt.player.exports.navigate")||Bf,void 0);t("yt.util.activity.init",v("yt.util.activity.init")||mf,void 0);t("yt.util.activity.getTimeSinceActive",v("yt.util.activity.getTimeSinceActive")||of,void 0);
t("yt.util.activity.setTimestamp",v("yt.util.activity.setTimestamp")||V,void 0);var Cf={log_event:"events",log_interaction:"interactions"},Df=Object.create(null);Df.log_event="GENERIC_EVENT_LOGGING";Df.log_interaction="INTERACTION_LOGGING";var Ef={},Ff={},Gf=0,W=v("ytLoggingTransportLogPayloadsQueue_")||{};t("ytLoggingTransportLogPayloadsQueue_",W,void 0);var Hf=v("ytLoggingTransportTokensToCttTargetIds_")||{};t("ytLoggingTransportTokensToCttTargetIds_",Hf,void 0);var If=v("ytLoggingTransportDispatchedStats_")||{};t("ytLoggingTransportDispatchedStats_",If,void 0);
t("ytytLoggingTransportCapturedTime_",v("ytLoggingTransportCapturedTime_")||{},void 0);function Jf(a,b){Ff[a.endpoint]=b;if(a.V){var c=a.V;var d={};c.videoId?d.videoId=c.videoId:c.playlistId&&(d.playlistId=c.playlistId);Hf[a.V.token]=d;c=Kf(a.endpoint,a.V.token)}else c=Kf(a.endpoint);c.push(a.payload);c.length>=(Number(S("web_logging_max_batch")||0)||20)?Lf():Mf()}
function Lf(){Wd(Gf);if(!bb(W)){for(var a in W){var b=Ef[a];if(!b){var c=Ff[a];if(!c)continue;b=new c;Ef[a]=b}c=void 0;var d=a,e=b,f=Cf[d],g=If[d]||{};If[d]=g;b=Math.round(N());for(c in W[d]){var h=e.b;h={client:{hl:h.Ca,gl:h.Ba,clientName:h.Aa,clientVersion:h.innertubeContextClientVersion}};P("DELEGATED_SESSION_ID")&&(h.user={onBehalfOfUser:P("DELEGATED_SESSION_ID")});h={context:h};h[f]=Kf(d,c);g.dispatchedEventCount=g.dispatchedEventCount||0;g.dispatchedEventCount+=h[f].length;h.requestTimeMs=b;
var k=Hf[c];if(k)a:{var m=h,u=c;if(k.videoId)var Z="VIDEO";else if(k.playlistId)Z="PLAYLIST";else break a;m.credentialTransferTokenTargetId=k;m.context=m.context||{};m.context.user=m.context.user||{};m.context.user.credentialTransferTokens=[{token:u,scope:Z}]}delete Hf[c];Nf(e,d,h)}c=g;d=b;c.previousDispatchMs&&(b=d-c.previousDispatchMs,e=c.diffCount||0,c.averageTimeBetweenDispatchesMs=e?(c.averageTimeBetweenDispatchesMs*e+b)/(e+1):b,c.diffCount=e+1);c.previousDispatchMs=d;delete W[a]}bb(W)||Mf()}}
function Mf(){Wd(Gf);Gf=T(Lf,P("LOGGING_BATCH_TIMEOUT",1E4))}
function Kf(a,b){b=void 0===b?"":b;W[a]=W[a]||{};W[a][b]=W[a][b]||[];return W[a][b]}
;function Of(a,b,c,d){var e=Pf,f={};f.eventTimeMs=Math.round(c||N());f[a]=b;f.context={lastActivityMs:String(c?-1:of())};Jf({endpoint:"log_event",payload:f,V:d},e)}
;function Qf(a,b,c){c.context&&c.context.capabilities&&(c=c.context.capabilities,c.snapshot||c.golden)&&(a="vix");return"/youtubei/"+a+"/"+b}
;function Pf(a){this.b=a||{innertubeApiKey:Od("INNERTUBE_API_KEY"),innertubeApiVersion:Od("INNERTUBE_API_VERSION"),Aa:P("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:Od("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ca:Od("INNERTUBE_CONTEXT_HL"),Ba:Od("INNERTUBE_CONTEXT_GL"),Da:Od("INNERTUBE_HOST_OVERRIDE")||""}}
function Nf(a,b,c){var d={};!P("VISITOR_DATA")&&.01>Math.random()&&Q(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json","X-Goog-Visitor-Id":P("VISITOR_DATA","")},method:"POST",A:c,ma:"JSON",K:function(){d.K()},
la:d.K,C:function(a,b){d.C&&d.C(b)},
ab:function(a){d.C&&d.C(a)},
onError:function(a,b){if(d.onError)d.onError(b)},
Za:function(a){if(d.onError)d.onError(a)},
timeout:d.timeout,withCredentials:!0},f=$b();f&&(e.headers.Authorization=f,e.headers["X-Goog-AuthUser"]=P("SESSION_INDEX",0));var g="",h=a.b.Da;h&&(g=h);f&&!g&&(e.headers["x-origin"]=window.location.origin);a=""+g+Qf(a.b.innertubeApiVersion,b,c)+"?alt=json&key="+a.b.innertubeApiKey;try{S("use_fetch_for_op_xhr")?Be(a,e):Ke(a,e)}catch(k){if("InvalidAccessError"==k)Q(Error("An extension is blocking network request."),"WARNING");else throw k;}}
;function Rf(a,b,c){Sf({attachChild:{csn:a,parentVisualElement:qf(b),visualElements:[qf(c)]}})}
function Sf(a){var b=Pf;a.eventTimeMs=Math.round(N());a.lactMs=of();Jf({endpoint:"log_interaction",payload:a},b)}
;function Tf(a){a=a||{};this.url=a.url||"";this.args=a.args||db(Uf);this.assets=a.assets||{};this.attrs=a.attrs||db(Vf);this.params=a.params||db(Wf);this.minVersion=a.min_version||"8.0.0";this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
var Uf={enablejsapi:1},Vf={},Wf={allowscriptaccess:"always",allowfullscreen:"true",bgcolor:"#000000"};function Xf(a){var b=new Tf,c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];b[c]="object"==sa(d)?db(d):d}return b}
;function Yf(){G.call(this);this.b=[]}
n(Yf,G);Yf.prototype.l=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.Wa)}G.prototype.l.call(this)};var Zf=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function $f(a){a=a||"";if(window.spf){var b=a.match(Zf);spf.style.load(a,b?b[1]:"",void 0)}else ag(a)}
function ag(a){var b=bg(a),c=document.getElementById(b),d=c&&Ud(c,"loaded");d||c&&!d||(c=cg(a,b,function(){Ud(c,"loaded")||(Sd(c),de(b),T(y(ee,b),0))}))}
...
function bg(a){var b=document.createElement("A");a=Bb(a);Eb(b,a);b=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Ua(b)}
;var dg=v("ytLoggingLatencyUsageStats_")||{};t("ytLoggingLatencyUsageStats_",dg,void 0);var eg=0;function fg(a){dg[a]=dg[a]||{count:0};var b=dg[a];b.count++;b.time=N();eg||(eg=We(gg,0,5E3));return 10<b.count?(11==b.count&&Re(Error("CSI data exceeded logging limit with key: "+a),0==a.indexOf("info")?"WARNING":"ERROR"),!0):!1}
...
ig.prototype.toString=function(){return this.topic};var jg=v("ytPubsub2Pubsub2Instance")||new I;I.prototype.subscribe=I.prototype.subscribe;I.prototype.unsubscribeByKey=I.prototype.H;I.prototype.publish=I.prototype.I;I.prototype.clear=I.prototype.clear;t("ytPubsub2Pubsub2Instance",jg,void 0);t("ytPubsub2Pubsub2SubscribedKeys",v("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);t("ytPubsub2Pubsub2TopicToKeys",v("ytPubsub2Pubsub2TopicToKeys")||{},void 0);t("ytPubsub2Pubsub2IsAsync",v("ytPubsub2Pubsub2IsAsync")||{},void 0);
t("ytPubsub2Pubsub2SkipSubKey",null,void 0);function kg(a,b){var c=v("ytPubsub2Pubsub2Instance");c&&c.publish.call(c,a.toString(),a,b)}
;var X=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};function lg(){var a=P("TIMING_TICK_EXPIRATION");a||(a={},O("TIMING_TICK_EXPIRATION",a));return a}
function mg(){var a=lg(),b;for(b in a)Ye(a[b]);O("TIMING_TICK_EXPIRATION",{})}
;function ng(a,b){hg.call(this,1,arguments)}
n(ng,hg);function og(a,b){hg.call(this,1,arguments)}
n(og,hg);var pg=new ig("aft-recorded"),qg=new ig("timing-sent");var rg=z().toString();var sg={vc:!0},tg={ad_allowed:"adTypesAllowed",ad_at:"adType",ad_cpn:"adClientPlaybackNonce",ad_docid:"adVideoId",yt_ad_an:"adNetworks",p:"httpProtocol",t:"transportProtocol",cpn:"clientPlaybackNonce",csn:"clientScreenNonce",docid:"videoId",is_nav:"isNavigation",yt_lt:"loadType",yt_ad:"isMonetized",nr:"webInfo.navigationReason",ncnp:"webInfo.nonPreloadedNodeCount",paused:"playerInfo.isPausedOnLoad",fmt:"playerInfo.itag",yt_pl:"watchInfo.isPlaylist",yt_ad_pr:"prerollAllowed",yt_red:"isRedSubscriber",
st:"serverTimeMs",vph:"viewportHeight",vpw:"viewportWidth",yt_vis:"isVisible"},ug="ap c cver ei srt yt_fss yt_li plid vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt pc prerender psc rc start yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),xg="isNavigation isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber isVisible watchInfo.isPlaylist".split(" "),yg=!1;
function zg(a){if("_"!=a[0]){var b=a;X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b))}b=Ag();var c=N();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;b=lg();if(c=b[a])Ye(c),b[a]=0;Bg()["tick_"+a]=void 0;N();S("csi_on_gel")?(b=Cg(),"_start"==a?fg("baseline_"+b)||Of("latencyActionBaselined",{clientActionNonce:b},void 0,void 0):fg("tick_"+a+"_"+b)||Of("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0,void 0),a=!0):a=!1;if(a=!a)a=!v("yt.timing.pingSent_");if(a&&(b=
Od("TIMING_ACTION"),a=Ag(),v("ytglobal.timingready_")&&b&&a._start&&(b=Dg()))){S("tighter_critical_section")&&!yg&&(kg(pg,new ng(Math.round(b-a._start),void 0)),yg=!0);b=!0;c=P("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Eg()}}
function Fg(){var a=Gg().info.yt_lt="hot_bg";Bg().info_yt_lt=a;if(S("csi_on_gel"))if("yt_lt"in tg){var b={},c=tg.yt_lt;0<=Ca(xg,c)&&(a=!!a);c=c.split(".");for(var d=b,e=0;e<c.length-1;e++)d[c[e]]=d[c[e]]||{},d=d[c[e]];b[c[c.length-1]]=a;a=Cg();c=Object.keys(b).join("");fg("info_"+c+"_"+a)||(b.clientActionNonce=a,Of("latencyActionInfo",b,void 0,void 0))}else 0<=Ca(ug,"yt_lt")||Q(Error("Unknown label yt_lt logged with GEL CSI."))}
...
function Eg(){mg();if(!S("csi_on_gel")){var a=Ag(),b=Gg().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&w(a[d])){var e=d.slice(1);if(e in sg){var f=Ea(a[d],function(a){return Math.round(a-c)});
...
delete b.h5jse}a.aft=Dg();Lg()&&"youtube"==g&&(Fg(),g=a.vc,k=a.pbs,delete a.aft,b.aft=Math.round(k-g));for(var m in b)"_"!=m.charAt(0)&&(f[m]=b[m]);a.ps=N();b={};m=[];for(d in a)"_"!=d.charAt(0)&&(g=Math.round(a[d]-c),b[d]=g,m.push(d+"."+g));f.rt=m.join(",");(a=v("ytdebug.logTiming"))&&a(f,b);Hg(f,e,void 0);kg(qg,new og(b.aft+(h||0),void 0))}}}
var Jg=x(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||qa,X);
function Hg(a,b,c){if(S("debug_csi_data")){var d=v("yt.timing.csiData");d||(d=[],t("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var f=void 0===f?"":f;try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,f)||Ne(a,void 0,void 0,void 0,f)}catch(g){Ne(a,void 0,void 0,void 0,f)}}else Ne(a);Kg(!0,c)}
...
;function Mg(a,b){G.call(this);this.m=this.R=a;this.G=b;this.o=!1;this.f={};this.O=this.F=null;this.w=new I;oc(this,y(pc,this.w));this.i={};this.M=this.P=this.h=this.Y=this.b=null;this.L=!1;this.j=this.D=null;this.S={};this.qa=["onReady"];this.X=null;this.ha=NaN;this.N={};Ng(this);this.U("WATCH_LATER_VIDEO_ADDED",this.Fa.bind(this));this.U("WATCH_LATER_VIDEO_REMOVED",this.Ga.bind(this));this.U("onAdAnnounce",this.ta.bind(this));this.ra=new Yf(this);oc(this,y(pc,this.ra))}
n(Mg,G);l=Mg.prototype;
l.ea=function(a){if(!this.g){a instanceof Tf||(a=new Tf(a));this.Y=a;this.b=Xf(a);this.h=this.b.attrs.id||this.h;"video-player"==this.h&&(this.h=this.G,this.b.attrs.id=this.G);this.m.id==this.h&&(this.h+="-player",this.b.attrs.id=this.h);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.G;this.P||(this.P=Og(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.m.style.width=Sb(Number(a)||a);if(a=this.b.attrs.height)this.m.style.height=Sb(Number(a)||
...
function Rg(a){var b=!0,c=Sg(a);c&&a.b&&(a=a.b,b=Ud(c,"version")==a.assets.js);return b&&!!v("yt.player.Application.create")}
function Pg(a){if(!a.g&&!a.L){var b=Rg(a);if(b&&"html5"==(Sg(a)?"html5":null))a.M="html5",a.o||Tg(a);else if(Ug(a),a.M="html5",b&&a.j)a.R.appendChild(a.j),Tg(a);else{a.b.loaded=!0;var c=!1;a.D=function(){c=!0;var b=Xf(a.b);v("yt.player.Application.create")(a.R,b);Tg(a)};
a.L=!0;b?a.D():(ie(a.b.assets.js,a.D),$f(a.b.assets.css),Vg(a)&&!c&&t("yt.player.Application.create",null,void 0))}}}
function Sg(a){var b=Jb(a.h);!b&&a.m&&a.m.querySelector&&(b=a.m.querySelector("#"+a.h));return b}
function Tg(a){if(!a.g){var b=Sg(a),c=!1;try{b&&b.getApiInterface&&b.getApiInterface()&&(c=!0)}catch(d){Rd(Error("Error calling getApiInterface: "+d))}c?(a.L=!1,b.isNotServable&&b.isNotServable(a.b.args.video_id)||Wg(a)):a.ha=T(function(){Tg(a)},50)}}
function Wg(a){Ng(a);a.o=!0;var b=Sg(a);b.addEventListener&&(a.F=Xg(a,b,"addEventListener"));b.removeEventListener&&(a.O=Xg(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.f[e]||(a.f[e]=Xg(a,b,e))}for(var f in a.i)a.F(f,a.i[f]);Qg(a);a.P&&a.P(a.f);a.w.I("onReady",a.f)}
function Xg(a,b,c){var d=b[c];return function(){try{return a.X=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.X=e,Rd(e))}}}
function Ng(a){a.o=!1;if(a.O)for(var b in a.i)a.O(b,a.i[b]);for(var c in a.N)Wd(parseInt(c,10));a.N={};a.F=null;a.O=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=a.U.bind(a);a.f.removeEventListener=a.Ma.bind(a);a.f.destroy=a.dispose.bind(a);a.f.getLastError=a.xa.bind(a);a.f.getPlayerType=a.ya.bind(a);a.f.getCurrentVideoConfig=a.wa.bind(a);a.f.loadNewVideoConfig=a.ea.bind(a);a.f.isReady=a.Ea.bind(a)}
l.Ea=function(){return this.o};
l.U=function(a,b){var c=this,d=Og(this,b);if(d){if(!(0<=Ca(this.qa,a)||this.i[a])){var e=Yg(this,a);this.F&&this.F(a,e)}this.w.subscribe(a,d);"onReady"==a&&this.o&&T(function(){d(c.f)},0)}};
l.Ma=function(a,b){if(!this.g){var c=Og(this,b);c&&cd(this.w,a,c)}};
...
function Yg(a,b){var c="ytPlayer"+b+a.G;a.i[b]=c;p[c]=function(c){var d=a.b&&a.b.args&&a.b.args.fflags;if(d&&0>d.indexOf("use_html5_player_event_timeout=true"))a.w.I(b,c);else{var f=T(function(){if(!a.g){a.w.I(b,c);var d=a.N,e=String(f);e in d&&delete d[e]}},0);
cb(a.N,String(f))}};
return c}
...
l.ya=function(){return this.M||(Sg(this)?"html5":null)};
l.xa=function(){return this.X};
function Ug(a){zg("dcp");a.cancel();Ng(a);a.M=null;a.b&&(a.b.loaded=!1);var b=Sg(a);b&&(Rg(a)||!Vg(a)?a.j=b:(b&&b.destroy&&b.destroy(),a.j=null));for(a=a.R;b=a.firstChild;)a.removeChild(b)}
l.cancel=function(){this.D&&oe(this.b.assets.js,this.D);Wd(this.ha);this.L=!1};
l.l=function(){Ug(this);if(this.j&&this.b&&this.j.destroy)try{this.j.destroy()}catch(b){Q(Error("Error destroying player: "+b))}this.S=null;for(var a in this.i)p[this.i[a]]=null;this.Y=this.b=this.f=null;delete this.R;delete this.m;G.prototype.l.call(this)};
function Vg(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var Zg={},$g="player_uid_"+(1E9*Math.random()>>>0);function ah(a){var b="player";b=r(b)?Jb(b):b;var c=$g+"_"+(b[wa]||(b[wa]=++xa)),d=Zg[c];if(d)return d.ea(a),d.f;d=new Mg(b,c);Zg[c]=d;de("player-added",d.f);oc(d,y(bh,d));T(function(){d.ea(a)},0);
return d.f}
...
function eh(a,b,c){if(va(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function fh(a,b,c,d){if(va(a)&&!w(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};r(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
function gh(a){var b=a.video_id||a.videoId;if(r(b)){var c=sf()||{},d=sf()||{};q(void 0)?d[b]=void 0:delete d[b];var e=z()+3E5,f=uf;if(f&&window.JSON){r(d)||(d=JSON.stringify(d,void 0));try{f.set("yt-player-two-stage-token",d,e)}catch(g){f.remove("yt-player-two-stage-token")}}(b=c[b])&&(a.two_stage_token=b)}}
;function hh(a){G.call(this);this.b=a;this.b.subscribe("command",this.na,this);this.f={};this.i=!1}
...
l.Oa=function(a,b){this.i&&!this.g&&ih(this.b,a,this.aa(a,b))};
l.aa=function(a,b){if(null!=b)return{value:b}};
function jh(a,b){b in a.f&&(a.removeEventListener(b,a.f[b]),delete a.f[b])}
l.l=function(){var a=this.b;a.g||cd(a.b,"command",this.na,this);this.b=null;for(var b in this.f)jh(this,b);hh.u.l.call(this)};function mh(a,b){hh.call(this,b);this.h=a;this.start()}
...
mh.prototype.aa=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return mh.u.aa.call(this,a,b)};
...
nh.prototype.sendMessage=function(a,b){var c=b||this.f;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=zc(a);c.postMessage(d,this.o)}catch(e){Q(e,"WARNING")}}};
...
n(oh,nh);function ph(){var a=this.g=new oh(!!P("WIDGET_ID_ENFORCE")),b=x(this.Ia,this);a.i=b;a.j=null;this.g.channel="widget";if(a=P("WIDGET_ID"))this.g.sessionId=a;this.h=[];this.j=!1;this.i={}}
l=ph.prototype;l.Ia=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.i[a]||"onReady"==a||(this.addEventListener(a,qh(this,a)),this.i[a]=!0)):this.pa(a,b,c)};
l.pa=function(){};
...
l.dispose=function(){this.g=null};function sh(a){ph.call(this);this.b=a;this.f=[];this.addEventListener("onReady",x(this.Ha,this));this.addEventListener("onVideoProgress",x(this.Sa,this));this.addEventListener("onVolumeChange",x(this.Ta,this));this.addEventListener("onApiChange",x(this.Na,this));this.addEventListener("onPlaybackQualityChange",x(this.Pa,this));this.addEventListener("onPlaybackRateChange",x(this.Qa,this));this.addEventListener("onStateChange",x(this.Ra,this))}
A(sh,ph);l=sh.prototype;l.pa=function(a,b,c){if(this.b[a]){b=b||[];if(0<b.length&&ch(a)){var d=b;if(va(d[0])&&!w(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=eh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=dh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=fh.apply(window,d)}d=e}gh(d);b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);ch(a)&&rh(this,this.ba())}};
...
l.Pa=function(a){rh(this,{playbackQuality:a})};
l.Qa=function(a){rh(this,{playbackRate:a})};
...
l.Ta=function(){rh(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
l.Sa=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:z()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());rh(this,a)};
l.dispose=function(){sh.u.dispose.call(this);for(var a=0;a<this.f.length;a++){var b=this.f[a];this.b.removeEventListener(b.eventType,b.listener)}this.f=[]};function th(){G.call(this);this.b=new I;oc(this,y(pc,this.b))}
A(th,G);th.prototype.subscribe=function(a,b,c){return this.g?0:this.b.subscribe(a,b,c)};
th.prototype.H=function(a){return this.g?!1:this.b.H(a)};
th.prototype.j=function(a,b){this.g||this.b.I.apply(this.b,arguments)};function uh(a,b,c){th.call(this);this.f=a;this.h=b;this.i=c}
A(uh,th);function ih(a,b,c){if(!a.g){var d=a.f;d.g||a.h!=d.b||(a={id:a.i,command:b},c&&(a.data=c),d.b.postMessage(zc(a),d.h))}}
uh.prototype.l=function(){this.h=this.f=null;uh.u.l.call(this)};function vh(a,b,c){G.call(this);this.b=a;this.h=c;this.i=U(window,"message",x(this.j,this));this.f=new uh(this,a,b);oc(this,y(pc,this.f))}
...
vh.prototype.l=function(){jf(this.i);this.b=null;vh.u.l.call(this)};function wh(){var a=xh()?"//googleads.g.doubleclick.net/pagead/id?exp=nomnom":"//googleads.g.doubleclick.net/pagead/id",b=db(yh);return new H(function(c,d){b.C=function(a){we(a)?c(a):d(new zh("Request failed, status="+a.status,"net.badstatus",a))};
b.onError=function(a){d(new zh("Unknown request error","net.unknown",a))};
b.K=function(a){d(new zh("Request timed out","net.timeout",a))};
Ee(a,b)})}
...
Ah.prototype.then=function(a,b,c){return this.f?this.f.then(a,b,c):1===this.g&&a?(a=a.call(c,this.b),Gc(a)?a:Bh(a)):2===this.g&&b?(a=b.call(c,this.b),Gc(a)?a:Ch(a)):this};
Ah.prototype.getValue=function(){return this.b};
Fc(Ah);function Ch(a){var b=new Ah;a=void 0===a?null:a;b.g=2;b.b=void 0===a?null:a;return b}
function Bh(a){var b=new Ah;a=void 0===a?null:a;b.g=1;b.b=void 0===a?null:a;return b}
;function Dh(a){B.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Eh;this.isTimeout=a instanceof zh&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Uc}
n(Dh,B);Dh.prototype.name="BiscottiError";function Eh(){B.call(this,"Biscotti ID is missing from server")}
n(Eh,B);Eh.prototype.name="BiscottiMissingError";var yh={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Fh=null;function Gh(){if("1"===Za(Pd(),"args","privembed"))return Lc(Error("Biscotti ID is not available in private embed mode"));Fh||(Fh=Tc(wh().then(Hh),function(a){return Ih(2,a)}));
return Fh}
function xh(){var a;(a=!!Za(window,"settings","experiments","flags","html5_serverside_pagead_id_sets_cookie"))||(a=!!P("EXP_HTML5_SERVERSIDE_PAGEAD_ID_SETS_COOKIE",!1));return a||!!S("html5_serverside_pagead_id_sets_cookie")}
...
function Kh(a,b){T(function(){Tc(wh().then(Hh,function(a){return Ih(b,a)}),qa)},a)}
function Jh(a){t("yt.ads.biscotti.lastId_",a,void 0)}
function Lh(){try{var a=v("yt.ads.biscotti.getId_");return a?a():Gh()}catch(b){return Lc(b)}}
;function Mh(a){B.apply(this,arguments)}
n(Mh,B);Mh.prototype.name="MutsuError";function Nh(){var a=new Mh("ID is missing"),b=new Mh("Timeout"),c=null,d=!1;Ld(function(){c=Jd();d=!0});
if(d)return c?Bh(c):Ch(a);var e=new H(function(b,c){Ld(function(){var d=Jd();d?b(d):c(a)})}),f=qd().then(function(){return Lc(b)});
return Rc(Oc([e,f]),function(){return f.cancel()})}
;function Oh(a){if("1"!==Za(Pd(),"args","privembed")){a&&!v("yt.ads.biscotti.getId_")&&t("yt.ads.biscotti.getId_",Gh,void 0);try{var b=Lh();if(S("enable_mutsu")){v("yt.ads.mutsu.getId_")||t("yt.ads.mutsu.getId_",Nh,void 0);try{var c=v("yt.ads.mutsu.getId_")()}catch(d){c=Lc(d)}}else c=Lc(new Mh("unimplemented"));Pc([b,c]).then(function(a){var b=a[0];a=a[1];if(b.Z||a.Z){b=b.value;a=a.value;var c={};c.dt=Tb;c.flash=Ad||"0";a:{try{var d=window.top.location.href}catch(Pa){d=2;break a}d=null!=d?d==window.document.location.href?
...
F.navigator.mimeTypes.length);d.ca_type=zd?"flash":"image";if(S("enable_server_side_search_pyv")||S("enable_server_side_mweb_search_pyv")){k=window;try{var m=k.screenX;var u=k.screenY}catch(Pa){}try{var Z=k.outerWidth;var Aa=k.outerHeight}catch(Pa){}try{var vg=k.innerWidth;var wg=k.innerHeight}catch(Pa){}m=[k.screenLeft,k.screenTop,m,u,k.screen?k.screen.availWidth:void 0,k.screen?k.screen.availTop:void 0,Z,Aa,vg,wg];u=window.top;try{var R=(u||window).document,Oa="CSS1Compat"==R.compatMode?R.documentElement:
R.body;var Ba=(new Ib(Oa.clientWidth,Oa.clientHeight)).round()}catch(Pa){Ba=new Ib(-12245933,-12245933)}R={};Oa=0;p.SVGElement&&p.document.createElementNS&&(Oa|=1);R.bc=Oa;R.bih=Ba.height;R.biw=Ba.width;R.brdim=m.join();Ba=(R.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Rb.webkitVisibilityState||Rb.mozVisibilityState||Rb.visibilityState||""]||0,R.wgl=!!F.WebGLRenderingContext,R);for(var Cd in Ba)d[Cd]=Ba[Cd]}void 0!==b&&(d.bid=b);void 0!==a&&(d.mutsuid=a);d.bsq=Ph++;Ke("//www.youtube.com/ad_data_204",
{za:!1,A:d})}});
T(Oh,18E5)}catch(d){Q(d)}}}
var Ph=0;var Y=v("ytglobal.prefsUserPrefsPrefs_")||{};t("ytglobal.prefsUserPrefsPrefs_",Y,void 0);function Qh(){this.b=P("ALT_PREF_COOKIE_NAME","PREF");var a;if(a=Zb.get(""+this.b,void 0)){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Y[d]=c.toString())}}}
...
l.save=function(){var a=this.b,b=[],c;for(c in Y)b.push(c+"="+encodeURIComponent(String(Y[c])));zf(a,b.join("&"),63072E3)};
...
ra(Qh);var Uh=null,Vh=null,Wh=null,Xh={};function Yh(a){Of(a.payload_name,a.payload,void 0,void 0)}
function Zh(a){var b=a.id;a=a.ve_type;var c=rf++;a=new pf(void 0,a,c,void 0,void 0);Xh[b]=a;b=yf();c=xf();b&&c&&Rf(b,c,a)}
function $h(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(O("client-screen-nonce",b),O("ROOT_VE_TYPE",a),a=xf()))for(var c in Xh){var d=Xh[c];d&&Rf(b,a,d)}}
function ai(a){Xh[a.id]=new pf(a.tracking_params)}
function bi(a){var b=yf();a=Xh[a.id];b&&a&&(S("interaction_click_on_gel_web")?Of("visualElementGestured",{csn:b,ve:qf(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"}):Sf({click:{csn:b,visualElement:qf(a)}}))}
function ci(a){a=a.ids;var b=yf();if(b)for(var c=0;c<a.length;c++){var d=Xh[a[c]];d&&Of("visualElementShown",{csn:b,ve:qf(d),eventType:1})}}
...
a.addEventListener("onLogVeClicked",bi);a.addEventListener("onLogVesShown",ci);a.addEventListener("onReady",di);b=P("POST_MESSAGE_ID","player");P("ENABLE_JS_API")?Wh=new sh(a):P("ENABLE_POST_API")&&r(b)&&r(c)&&(Vh=new vh(window.parent,b,c),Wh=new mh(a,Vh.f));P("BG_P")&&(P("BG_I")||P("BG_IU"))&&qe();af()},void 0);
t("yt.www.watch.ads.restrictioncookie.spr",function(a){Ne(a+"mac_204?action_fcts=1");return!0},void 0);
var ei=Qd(function(){zg("ol");var a=Qh.getInstance(),b=!!((Th("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&sc(document.body,"exp-invert-logo"))if(c&&!sc(document.body,"inverted-hdpi")){var d=document.body;d.classList?d.classList.add("inverted-hdpi"):sc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")}else!c&&sc(document.body,"inverted-hdpi")&&tc();b!=c&&(b="f"+(Math.floor(119/31)+1),d=Th(b)||0,d=c?d|67108864:d&-67108865,
0==d?delete Y[b]:Y[b]=d.toString(16).toString(),a.save())}),fi=Qd(function(){var a=Uh;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&(pe=null);a=0;for(var b=Ze.length;a<b;a++)Ye(Ze[a]);Ze.length=0;ne("//static.doubleclick.net/instream/ad_status.js");$e=!1;O("DCLKSTAT",0);qc(Wh,Vh);if(a=Uh)a.removeEventListener("onScreenChanged",$h),a.removeEventListener("onLogClientVeCreated",Zh),a.removeEventListener("onLogServerVeCreated",ai),a.removeEventListener("onLogToGel",Yh),a.removeEventListener("onLogVeClicked",bi),a.removeEventListener("onLogVesShown",ci),a.removeEventListener("onReady",
di),a.destroy();Xh={}});
